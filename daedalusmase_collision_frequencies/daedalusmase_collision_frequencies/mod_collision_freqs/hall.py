...
def hall(bnorm,ne,nop,no2p,nnop,ven,vop,vo2p,vnop):
    ...
    sigmaped_e=fac*ne*ke*ke/(1+ke*ke)
    sigmaped_op=fac*nop*kop*kop/(1+kop*kop)
    sigmaped_o2p=fac*no2p*ko2p*ko2p/(1+ko2p*ko2p)
    sigmaped_nop=fac*nnop*knop*knop/(1+knop*knop)
