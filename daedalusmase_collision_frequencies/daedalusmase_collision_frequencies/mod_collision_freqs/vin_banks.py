...
def vin_banks(Ti,Tn,NO2,NO,NN2):
    ...
    vinOp_O=2.3*10**(-13)*NO*10**(-6)*(Tr**(0.5))*(10.5-0.61*np.log10(Tr))*(10.5-0.61*np.log10(Tr))

    vinO2p_O2=1.7*10**(-13)*NO2*10**(-6)*(Tr**(0.5))*(10.6-0.76*np.log10(Tr))*(10.6-0.76*np.log10(Tr))
