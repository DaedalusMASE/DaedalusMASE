"""
sub_Heating_Sources.regrid

**Description**:
_____________________________________________________________________________________________________________________

Regrids a TIEGCM NetCDF file from pressure defined grid to altitude defined grid
...
`minAlt`: minimum altitude in \(km\)

`maxAlt`: maximum altitude in \(km\)

`dz`: altitude resolution in \(km\)

`tiegcm_file`: TIEGCM NetCDF file

`timesteps`: list of timesteps

`params`: list of TIEGCM parameters

`output_path`: output path for the generated NetCDF file
